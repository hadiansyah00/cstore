...
class Transaksi_model extends CI_Model {
    ...
    public function transaksiDetail($id) {
        ...
        $res = $this->db->query("SELECT a.*,b.nama_kurir,b.level_kurir,b.lama_pengiriman FROM tx_transaksi a LEFT JOIN tx_kurir b ON a.no_transaksi=b.no_transaksi WHERE a.transaksi_id='$id' ORDER BY a.transaksi_id DESC ")->result_array();
        foreach ($res as $rows) {
