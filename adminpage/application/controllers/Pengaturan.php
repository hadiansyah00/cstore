...
class Pengaturan extends CI_Controller {
    ...
    public function sistem($nb = null) {
        ...
        $this->form_validation->set_rules('status_wablas', '', 'required');

        $this->form_validation->set_rules('kirim_transaksi_email', '', 'required');
        ...
        $this->form_validation->set_rules('smtp_setnama', '', 'required');
