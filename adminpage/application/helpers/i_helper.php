...
function wablasOtp($phone,$code,$token,$server){
    ...
    $data = [
    'phone' => $phone,
    'message' => 'Berikut kode aktivasi login cStore #'.$code.', jangan berikan kode aktivasi ini kepada siapapun.',
    ];
...
function emailTestSmtp($emailto,$mail){
    ...
    $mail->Password = 'xxx'; // pass email domain
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" style="font-family: sans-serif; font-size: 14px; color: #ffffff;">
                          Copyright &copy; 2023 '.$set_p['smtp_setnama'].' All Right Reserved
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td bgcolor="#fff" style="border-bottom: 2px solid #37b464; padding: 10px 30px 10px 30px;">
                    <table align="left" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td height="70">
                          <span style="font-size: 24px; font-weight: bold; font-family: sans-serif;">cStore by '.$set_p['smtp_setnama'].'</span>
                        </td>
                      </tr>
                    </table>
                  </td>
