<?php 
	...
	if ($_GET['jen']=='signin_login') {
		$arr = array('tipe' => 'web', 'email' => $_POST['alamat_email'], 'password' => $_POST['password'], 'option' => $_GET['option_lg'], 'lang' => 'en');
	...
	if ($_GET['jen']=='activation_otp') {
		$arr = array('tipe' => 'web', 'email' => $_POST['alamat_email'], 'kode_aktivasi' => $_POST['kode_otp'], 'option' => $_GET['option_lg'], 'onesignalid' => '', 'lang' => 'en');
